...
<div class="col-md-12">
    <?= Yii::t('app', 'Klik') ?> <?= Html::a(Yii::t('app', 'disini'), ['/pendaftaran/anggota-aktif/']); ?>,
    <?= Yii::t('app', 'jika anda telah terdaftar sebagai anggota, namun belum memiliki user dan password akses layanan Keanggotaan Online.') ?>
    <br /><br />
